	...
	func test0Insert() {
		do {
			...
			if let
				...
				H0: Cell = context.newCell(width: 256, label: "H0", input: [I]),
				H1: Cell = context.newCell(width: 256, label: "H1", input: [I]),//, H0]),
				H2: Cell = context.newCell(width: 256, label: "H2", input: [I]),//, H0, H1]),
				H3: Cell = context.newCell(width: 256, label: "H3", input: [I]),//, H0, H1, H2]),
				H4: Cell = context.newCell(width: 256, label: "H4", input: [I]),//, H0, H1, H2, H3]),
				H5: Cell = context.newCell(width: 256, label: "H5", input: [I]),//, H0, H1, H2, H3, H4]),
				H6: Cell = context.newCell(width: 256, label: "H6", input: [I]),//, H0, H1, H2, H3, H4, H5]),
				H7: Cell = context.newCell(width: 256, label: "H7", input: [I]),//, H0, H1, H2, H3, H4, H5, H6]),
